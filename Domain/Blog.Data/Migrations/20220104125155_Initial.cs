        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeoAlias = table.Column<string>(maxLength: 300, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Environment = table.Column<string>(maxLength: 300, nullable: false),
                    Problem = table.Column<string>(maxLength: 300, nullable: false),
                    StepToReproduce = table.Column<string>(maxLength: 300, nullable: false),
                    Workaround = table.Column<string>(maxLength: 300, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommandInFunctions", x => x.CommandId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Permissions", x => x.FunctionId);
                });
